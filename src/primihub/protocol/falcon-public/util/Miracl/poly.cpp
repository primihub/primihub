    ...
    namespace falcon
    {
        ...
        Poly operator*(const Poly &a, const Poly &b)
        {
            ...
            {                          // use fast methods
                ...
                if (!squaring)
                    B = (big *)mr_alloc(degb + 1, sizeof(big));

...
#define MR_ZERO_ZZN3    \
    ...
    public:
        ZZn3(){MR_INIT_ZZN3 MR_ZERO_ZZN3} ZZn3(int w) { MR_INIT_ZZN3 if (w == 0) MR_ZERO_ZZN3 else zzn3_from_int(w, &fn); }
        ZZn3(const ZZn3 &w){MR_INIT_ZZN3 MR_CLONE_ZZN3(w)} ZZn3(const ZZn &x, const ZZn &y, const ZZn &z) { MR_INIT_ZZN3 zzn3_from_zzns(x.getzzn(), y.getzzn(), z.getzzn(), &fn); }
        ...
        {
            if (i == 0)
                MR_ZERO_ZZN3 else zzn3_from_int(i, &fn);
            return *this;
        }
        ZZn3 &operator=(const ZZn &x)
        {
            zzn3_from_zzn(x.getzzn(), &fn);
            return *this;
        }
        ...
        ZZn3 &operator+=(const ZZn &x)
        {
            zzn3_sadd(&fn, x.getzzn(), &fn);
            return *this;
        }
        ZZn3 &operator+=(const ZZn3 &x)
        {
            zzn3_add(&fn, (zzn3 *)&x, &fn);
            return *this;
        }
        ZZn3 &operator-=(const ZZn &x)
        {
            zzn3_ssub(&fn, x.getzzn(), &fn);
            return *this;
        }
        ZZn3 &operator-=(const ZZn3 &x)
        {
            zzn3_sub(&fn, (zzn3 *)&x, &fn);
            return *this;
        }
        ZZn3 &operator*=(const ZZn3 &x)
        {
            zzn3_mul(&fn, (zzn3 *)&x, &fn);
            return *this;
        }
        ZZn3 &operator*=(const ZZn &x)
        {
            zzn3_smul(&fn, x.getzzn(), &fn);
            return *this;
        }
        ZZn3 &operator*=(int x)
        {

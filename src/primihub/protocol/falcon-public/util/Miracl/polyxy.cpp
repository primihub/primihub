    ...
    namespace falcon
    {
        ...
        */
        ...
        PolyXY &PolyXY::operator%=(const PolyXY &v)
        {
            ...
            termXY *vptr = v.start;
            termXY *ptr, *pos;
            if (degreeX(*this) < degreeX(v) && degreeY(*this) < degreeY(v))
                return *this;
            m = ((ZZn)1 / vptr->an);
        ...
        {
            if (degreeX(p) == 0 && degreeY(p) == 0 && (p.coeff(0, 0) == 0))
                return TRUE;
            else
                return FALSE;
        }
        ...
        {
            if (degreeX(p) == 0 && degreeY(p) == 0 && p.coeff(0, 0) == 1)
                return TRUE;
            else
                return FALSE;
        }

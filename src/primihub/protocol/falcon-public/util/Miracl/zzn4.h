...
#define MR_CLONE_ZZN4(x)                \
    {                                   \
        fn.unitary = x.fn.unitary;      \
        at.len = x.at.len;              \
        bt.len = x.bt.len;              \
        ct.len = x.ct.len;              \
        dt.len = x.dt.len;              \
...
#endif
    public:
        ZZn4(){MR_INIT_ZZN4 MR_ZERO_ZZN4} ZZn4(int w) { MR_INIT_ZZN4 if (w == 0) MR_ZERO_ZZN4 else zzn4_from_int(w, &fn); }
        ZZn4(const ZZn4 &w){MR_INIT_ZZN4 MR_CLONE_ZZN4(w)} ZZn4(const ZZn2 &x) { MR_INIT_ZZN4 zzn4_from_zzn2(x.getzzn2(), &fn); }
        ...
        void seth(const ZZn2 &x)
        {
            zzn2_copy(x.getzzn2(), &(fn.b));
            zzn2_zero(&(fn.a));
            fn.unitary = FALSE;
        }
        ...
        {
            if (i == 0)
                MR_ZERO_ZZN4 else zzn4_from_int(i, &fn);
            return *this;
        }
        ZZn4 &operator=(const ZZn2 &x)
        {
            zzn4_from_zzn2(x.getzzn2(), &fn);
            return *this;
        }
        ...
        ZZn4 &operator=(const ZZn &x)
        {
            zzn4_from_zzn(x.getzzn(), &fn);
            return *this;
        }
        ZZn4 &operator+=(const ZZn2 &x)
        {
            zzn4_sadd(&fn, x.getzzn2(), &fn);
            return *this;
        }
        ZZn4 &operator+=(const ZZn &x)
        {
            zzn2_sadd(&(fn.a), x.getzzn(), &(fn.a));
            return *this;
        }
        ZZn4 &operator+=(const ZZn4 &x)
        {
            zzn4_add(&fn, (zzn4 *)&x.fn, &fn);
            return *this;
        }
        ZZn4 &operator-=(const ZZn2 &x)
        {
            zzn4_ssub(&fn, x.getzzn2(), &fn);
            return *this;
        }
        ZZn4 &operator-=(const ZZn &x)
        {
            zzn2_ssub(&(fn.a), x.getzzn(), &(fn.a));
            return *this;
        }
        ZZn4 &operator-=(const ZZn4 &x)
        {
            zzn4_sub(&fn, (zzn4 *)&x.fn, &fn);
            return *this;
        }
        ZZn4 &operator*=(const ZZn4 &x)
        {
            zzn4_mul(&fn, (zzn4 *)&x.fn, &fn);
            return *this;
        }
        ZZn4 &operator*=(const ZZn2 &x)
        {
            zzn4_smul(&fn, x.getzzn2(), &fn);
            return *this;
        }
        ZZn4 &operator*=(const ZZn &x)
        {
            zzn4_lmul(&fn, x.getzzn(), &fn);
            return *this;
        }
        ZZn4 &operator*=(int i)
        {

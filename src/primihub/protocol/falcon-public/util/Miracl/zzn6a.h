...
#include "zzn2.h"
    ...
    public:
        ...
        ZZn6(const ZZn2 &x, const ZZn2 &y, const ZZn2 &z)
        {
            a = x;
            b = y;
            c = z;
        ...
        void set(const ZZn2 &x, const ZZn2 &y, const ZZn2 &z)
        {
            a = x;
            b = y;
            c = z;
        ...
        void set(const ZZn2 &x, const ZZn2 &y)
        {
            a = x;
            b = y;
            c.clear();

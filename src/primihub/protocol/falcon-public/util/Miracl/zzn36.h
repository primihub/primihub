...
namespace primihub
{
    namespace falcon
    {
        ...
        public:
            ...
            void set(const ZZn12 &x, const ZZn12 &y)
            {
                a = x;
                b = y;
                c.clear();

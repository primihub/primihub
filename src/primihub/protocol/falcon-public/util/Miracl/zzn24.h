...
#include "zzn8.h"
        ...
        public:
            ...
            ZZn24(const ZZn8 &x)
            {
                ...
                b.clear();
                c.clear();
                miller = unitary = FALSE;
            }
            ZZn24(const ZZn8 &x, const ZZn8 &y, const ZZn8 &z)
            {
                a = x;
                b = y;
                c = z;
            ...
            void set(const ZZn8 &x, const ZZn8 &y, const ZZn8 &z)
            {
                a = x;
                b = y;
                c = z;
            ...
            void set(const ZZn8 &x, const ZZn8 &y)
            {
                a = x;
                b = y;
                c.clear();
            ...
            BOOL isunity() const
            {
                if (a.isunity() && b.iszero() && c.iszero())
                    return TRUE;
                return FALSE;
            }

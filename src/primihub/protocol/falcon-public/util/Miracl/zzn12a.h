...
#include "zzn4.h"
    ...
    public:
        ...
        ZZn12(const ZZn4 &x, const ZZn4 &y, const ZZn4 &z)
        {
            a = x;
            b = y;
            c = z;
        ...
        void set(const ZZn4 &x, const ZZn4 &y, const ZZn4 &z)
        {
            a = x;
            b = y;
            c = z;
        ...
        void set(const ZZn4 &x, const ZZn4 &y)
        {
            a = x;
            b = y;
            c.clear();

...
#include "zzn6.h"
    ...
    public:
        ...
        ZZn12(const ZZn6 &x, const ZZn6 &y)
        {
            a = x;
            b = y;
            unitary = FALSE;
        ...
        void set(const ZZn6 &x, const ZZn6 &y)
        {
            a = x;
            b = y;
            unitary = FALSE;
        ...
        void set(const ZZn6 &x)
        {
            a = x;
            b.clear();
            unitary = FALSE;
        }
        void seti(const ZZn6 &x)
        {
            a.clear();
            b = x;
            unitary = FALSE;

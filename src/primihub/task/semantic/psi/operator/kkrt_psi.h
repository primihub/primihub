...
#ifndef SRC_PRIMIHUB_TASK_SEMANTIC_PSI_OPERATOR_KKRT_PSI_H_
#define SRC_PRIMIHUB_TASK_SEMANTIC_PSI_OPERATOR_KKRT_PSI_H_
#include <vector>
#include <map>
#include <memory>
#include <string>
...
#endif  // SRC_PRIMIHUB_TASK_SEMANTIC_PSI_OPERATOR_KKRT_PSI_H_

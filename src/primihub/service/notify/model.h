...
class NotifyDelegate {
    public:
        virtual void notifyStatus(const std::string &job_id, const std::string &task_id, const std::string &submit_client_id,
                                 const std::string &status, const std::string &message) = 0;
        virtual void notifyResult(const std::string &job_id, const std::string &task_id, const std::string &submit_client_id,
...
class EventBusNotifyDelegate {
    public:
        ...
        void notifyStatus(const std::string& job_id,
                         const std::string& task_id,
                         const std::string& submit_client_id,
                         const std::string& status,
                         const std::string& message);
        void notifyResult(const std::string& job_id,
                          const std::string& task_id,
                          const std::string& submit_client_id,

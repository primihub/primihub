  ...
  for (int h = 0; h < 3; h++)
    for (int i = 0; i < train_shares[h].rows(); i++)
      for (int j = 0; j < train_shares[h].cols() - 1; j++)
        train_data(row_index++, j) = train_shares[h](i, j);
  ...
  for (int h = 0; h < 3; h++)
    for (int i = 0; i < test_shares[h].rows(); i++)
      for (int j = 0; j < test_shares[h].cols() - 1; j++)
        test_data(row_index++, j) = test_shares[h](i, j);

  row_index = 0;
  for (int h = 0; h < 3; h++)
    for (int i = 0; i < test_shares[h].rows(); i++)
      test_label(row_index++, 0) = test_shares[h](i, num_cols);

 ...
 * limitations under the License.
 */
#ifndef SRC_PRIMIHUB_TASK_ENGINE_PY_EXECUTOR_H_
#define SRC_PRIMIHUB_TASK_ENGINE_PY_EXECUTOR_H_
#include <memory>
#include <map>
#include <vector>
#include <string>
...
class PyExecutor {
 ...
 protected:
    ...
    std::string node_id() const {return this->node_id_;}
...
#endif  // SRC_PRIMIHUB_TASK_ENGINE_PY_EXECUTOR_H_

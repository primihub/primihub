...
3.注意问题
        ...
        2) 如果test_mpc.py失败，请注意node2节点的配置。
        3) 如果test_fl.py失败，请注意是否在primihub/python目录下执行了 python3.9 setup.py install.
----------------------------------------------------------
pytest的常见参数

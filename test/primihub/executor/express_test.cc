...
//           runParty(col_and_val_0, col_and_dtype, col_and_owner, 0,
//           "127.0.0.1",
//                    "127.0.0.1", 10010, 10020, bit_flag);
...
//       MPCExpressExecutor<D32> *mpc_exec =
//           runParty(col_and_val_1, col_and_dtype, col_and_owner, 1,
//           "127.0.0.1",
//                    "127.0.0.1", 10030, 10010, bit_flag);
//       delete mpc_exec;
//     } else if (std::string(std::getenv("MPC_PARTY")) == "PARTY_2") {
//       MPCExpressExecutor<D32> *mpc_exec =
//           runParty(col_and_val_2, col_and_dtype, col_and_owner, 2,
//           "127.0.0.1",
//                    "127.0.0.1", 10020, 10030, bit_flag);
//       delete mpc_exec;
//     }
...
TEST(mpc_express_executor, i64_executor_test) {
  ...
  if (single_terminal) {
    ...
    if (std::string(std::getenv("MPC_PARTY")) == std::string("PARTY_0")) {
      MPCExpressExecutor<D32> *mpc_exec =
          runParty(col_and_val_0, col_and_dtype, col_and_owner, 0,
                   "127.0.0.1", "127.0.0.1", 10010, 10020, bit_flag);

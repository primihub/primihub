...
def test_vert_zscore():
    ...
    expected_zscore = np.array([
        ...
        [-0.8784933242545472, -1.1563271307870988, -1.5343785266876018, -0.7846326472839595, -0.6036176213050711, -0.6446959017477358, 0.9776949752162054, -1.5128653035809212]])
...
def test_hor_union():
    ...
    expected_zscore = np.array([
        ...
        [-0.8769493486756695, -1.1514311176359293, -1.5128227412383755, -0.7664219708705837, -0.5465270284163023, -0.6079075282642789, 1.0958614998434957, -1.4092308169820342]])
